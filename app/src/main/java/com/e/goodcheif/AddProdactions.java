...
public class AddProdactions extends AppCompatActivity {
    ...
    EditText title,details,price,type;
    TextView post ;
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_prodactions);
        identity();
        char_item();
        select_image();
    }
    ...
    private void identity(){
        ...
        type=findViewById(R.id.editText7);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(add>4){
                    ...
                    popularFood.setName(title.getText().toString());
                    popularFood.setImageUrl(pos);
                    popularFood.setPrice(price.getText().toString());
                    popularFood.setOffer("0");
                    FirebaseDatabase.getInstance().getReference()
                            .child("Food").child(String.valueOf(pos)).setValue(popularFood);
    ...
    private  void char_item(){
        EditText[]texts={title,details,price,type};
    ...
    private void upload_file(String f){
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(AddProdactions.this, exception.toString(), Toast.LENGTH_SHORT).show();
            }
